/*
 * This code is tailored for a WeMos D1 mini board, but should work with other ESP 8266 boards
 * if ledPin and buttonPin assignments are adjusted.
 * You will also have to adjust 'role' it needs to be unique in your environment.
 */
